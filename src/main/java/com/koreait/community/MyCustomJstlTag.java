...
public class MyCustomJstlTag extends SimpleTagSupport {
    ...
    public void doTag() throws JspException {
        try {
            /*
            String fixProfileImgVal = "/res/img/defaultProfile.jpg";
            if(profileImgVal != null) {
                fixProfileImgVal = String.format("/images/user/%s/%s", iuser, profileImgVal);
            }
            */
            String fixProfileImgVal = "".equals(profileImgVal) ? "/res/img/defaultProfile.jpg" : String.format("/images/user/%s/%s", iuser, profileImgVal);
